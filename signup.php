...
<!-- 
  ...
  <!-- <div class="form-group">
    <div>
      <label for="phone" class="col-sm-10" >Phone Number</label>
    </div> -->
  ...
  <div class="form-group">
  <div>
      <label for="confirm password" class="col-sm-10"> Confirm password </label>
    </div> -->
    <!-- <label for="password" class="col-sm-2 control-label">Password</label> -->
    <!-- <div class="col-sm-10">
      <input type="password" class="form-control input-lg" id="password2" placeholder="Confrim password" name="password2">
    </div>
  </div> -->
<!-- 
  <div clas="form-group">
