        ...
        <div class="card-body card-body-padding px-3 d-flex align-items-center justify-content-between">
          <div class="ps-lg-3">
            <div class="d-flex align-items-center justify-content-between">
              <p class="mb-0 font-weight-medium me-3 buy-now-text"> Welcome Back</p>
              <a href="" target="_blank" class="btn me-2 buy-now-btn border-0">Tangaza</a>
            </div>
          </div>
          <div class="d-flex align-items-center justify-content-between">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Tangazo Form</a></li>
              </ul> 
            </div>
          </li>
